...
- Callsites:
  - gamma_walo/gamedata/scripts/game_relations.script:66:friend_limit = safe_ini_r_float(ini_r, "controls" ,"friend_limit", 4100)
  - gamma_walo/gamedata/scripts/game_relations.script:67:enemy_limit = safe_ini_r_float(ini_r, "controls" ,"enemy_limit", -5000)
  - gamma_walo/gamedata/scripts/game_relations.script:68:local death_value = safe_ini_r_float(ini_r, "controls" ,"death_value", 150)
  - gamma_walo/gamedata/scripts/game_relations.script:69:local friend_count_limit = safe_ini_r_float(ini_r, "controls" ,"friend_count_limit", 3)
  - gamma_walo/gamedata/scripts/game_relations.script:70:local enemy_count_limit = safe_ini_r_float(ini_r, "controls" ,"enemy_count_limit", 3)
...
- Callsites:
  - gamma_walo/gamedata/scripts/smart_terrain_warfare.script:894:if (not game_relations.is_relation_allowed(faction_1,faction_2)) or (game_relations.is_faction_pair_unaffected(faction_1,faction_2)) or (faction_1 == faction_2) then
  - gamma_walo/gamedata/scripts/game_relations.script:412:if is_relation_allowed( faction , killer_faction ) and ( natural_num + friend_num > friend_count_limit ) then
  - gamma_walo/gamedata/scripts/game_relations.script:452:if is_relation_allowed( faction , killer_faction ) and ( enemy_num > enemy_count_limit ) then
  - gamma_walo/gamedata/scripts/game_relations.script:475:if (comm ~= faction) and is_factions_enemies(faction, comm) and is_relation_allowed(faction , comm) then
  - gamma_walo/gamedata/scripts/game_relations.script:487:if (comm ~= faction) and (not is_factions_enemies(faction, comm)) and is_relation_allowed(faction , comm) then
  - runtime files/gamedata/scripts/smart_terrain_warfare.script:893:if (not game_relations.is_relation_allowed(faction_1,faction_2)) or (game_relations.is_faction_pair_unaffected(faction_1,faction_2)) or (faction_1 == faction_2) then
...
- Callsites:
  - gamma_walo/gamedata/scripts/game_relations.script:589:reset_all_relations()
...
- Callsites:
  - gamma_walo/gamedata/scripts/game_relations.script:532:calculate_relation_change( victim_tbl, killer_tbl)
  - gamma_walo/gamedata/scripts/game_relations.script:570:calculate_relation_change( victim_tbl, killer_tbl)
